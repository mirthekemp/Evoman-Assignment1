...
mutation_rate_values = [0.3, 0.1, 0.2]
sigma_values = [1.5, 1.0, 0.5]
learning_rate_values = [0.4, 0.1, 0.2]
k_values = [2, 10, 5]
            ...
            for k in k_values:
                ...
                # Loop through generations
                    for i in range(1,n_generations):
                        ...
                        offspring = [self_adapt_mutate(gene, mutation_rate, sigmav) for gene in offspring]
                        ...
                        if i == n_generations-1:
                            if max(pop_gain) > current_gain:
                                best_hyperparameters = [mutation_rate, sigmav, learning_rate, k]

print(f"Best hyperparameters (mutation_rate, sigmav, learning_rate, k): {best_hyperparameters}")

...
enemy = 1
results_list = [f'EA1_enemy{enemy}_param1/EA1_enemy{enemy}_param1.csv', f'EA2_enemy{enemy}_param1/EA2_enemy{enemy}_param1.csv']
_10runs_2enemies = []
...
#  save figure
plt.savefig(f'EA_BOXPLOTS\Boxplots_EAvEA2_enemy{enemy}_3runs')
plt.show()
